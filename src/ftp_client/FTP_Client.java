...
public class FTP_Client {
    public static void main(String[] args) throws IOException {
        try {
            ...
            DataInputStream clientRead = new DataInputStream(server.getInputStream()); // to read information from
                                                                                       // server.
            DataOutputStream clientWrite = new DataOutputStream(server.getOutputStream()); // to send information to
                                                                                           // server.
                ...
                // if client entered right information
                    ...
                    while (true) {
                        ...
                        if (close.equalsIgnoreCase("y"))
                            return; // if client want to close connection.
                        // continue connection...
                        ...
                        Socket server2 = new Socket(InetAddress.getLocalHost(), 33223); // connect on server with
                                                                                        // port(33223).
                        ...
                        // Request the file
                        ObjectOutputStream obj_output_stream = new ObjectOutputStream(server2.getOutputStream()); // to
                                                                                                                  // write
                                                                                                                  // obj.
                        obj_output_stream.writeObject("C:\\Users\\hp\\Desktop\\Test\\FTP-Client-Server-Application\\"
                                + "Directories\\" + myDirection + "\\" + mychoose + Extension); // path
                        // of
                        // File
                        // wanted.
                        ...
                        FileOutputStream file_input = new FileOutputStream(
                                "C:\\Users\\hp\\Desktop\\Test\\FTP-Client-Server-Application\\"
                                        + "UserNames\\" + mychoose + Extension); // path
                                                                                 // to
                                                                                 // download
                                                                                 // the
                                                                                 // file.
                        ...
                        while (sizeOfArray > -1) {
                            sizeOfArray = input_stream.read(bytesArray, current_size,
                                    (bytesArray.length - current_size));
                            if (sizeOfArray >= 0)
                                current_size += sizeOfArray;
                        }
