...
public class FTP_Server {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("A new client " + client + " connected to the server."); // print information that
                                                                                            // client is connected.
                ClientConnection clientconnection = new ClientConnection(client, server2); // obj of class that
                                                                                           // threading clients and run
                                                                                           // parallel.
    ...
    static class ClientConnection extends Thread {
        ...
        public void run() {
            try {
                DataInputStream serverRead = new DataInputStream(client.getInputStream()); // to read information from
                                                                                           // client.
                DataOutputStream serverWrite = new DataOutputStream(client.getOutputStream()); // to send information to
                                                                                               // client.

                while (true) {
                    String checkUsers = serverRead.readUTF(); // recieve username from client.
                    File file = new File("C:\\Users\\hp\\Desktop\\Test\\FTP-Client-Server-Application\\UserNames\\"
                            + checkUsers + "\\" + checkUsers + ".txt");
                    System.out.println("Checking file path: " + file.getAbsolutePath());
                    boolean checkState; // check state of connection.
                    System.out.println("Received Username: 1" + checkUsers);
                    ...
                    if (file.exists()) {
                        ...
                        if (pass.equals(Password)) {
                            ...
                            while (true) {
                                ...
                                serverWrite.writeUTF("the available dirs.(Movies, Music, Docs, …)."); // sending the
                                                                                                      // available
                                                                                                      // directories.
                                ...
                                obj_input_stream = new ObjectInputStream(client2.getInputStream()); // receive the
                                                                                                    // request.
                                try {
                                ...
                                System.out.println("the requested file is " + fileWanted); // print path of file
                                                                                           // required.
                                ...
                                output_stream.write(bytesArray, 0, bytesArray.length); // send required file and its
                                                                                       // size.
                        ...
                        // if client entered wrong password.
                            ...
                            // System.out.println("Received Username: " + checkUsers);
